...
def history():
    ...
    history_window.configure(background='#DAB9FF')
    ...
    history_title_label.config(font=("Comic Sans MS", 20, "underline"), background="#DAB9FF")
...
def setup_buttons():
    ...
    quit_button.config(height=1, width=17, font=("Comic Sans MS", 30), bg="#B78AD5")

    submit_button = Button(main_window, text="Submit", command=submit)
    submit_button.place(x=40, y=700)
    submit_button.config(height=1, width=38, font=("Comic Sans MS", 30), bg="#B78AD5")

    history_button = Button(main_window, text="History", command=history)
    history_button.place(x=40, y=850)
    history_button.config(height=1, width=17, font=("Comic Sans MS", 30), bg="#B78AD5")
...
def setup_main_window():
    ...
    title_label.config(font=("Comic Sans MS", 45, "underline"), background="#DAB9FF")
...
main_window = Tk()    
main_window.configure(background='#DAB9FF')
