...
def history():
    ...
    history_title_label.config(font=("Arial", 20, "underline"))
    ...
    delete_button.config(height=1, width=10, font=("Arial", 15))

    # Add a close button
    close_button = Button(history_window, text="Close", command=history_window.destroy)
    close_button.pack(pady=10)
    close_button.config(height=1, width=10, font=("Arial", 15))
...
def setup_main_window():
    ...
    first_name.config(font=("Arial", 20), width=21)
    ...
    last_name.config(font=("Arial", 20), width=21)
