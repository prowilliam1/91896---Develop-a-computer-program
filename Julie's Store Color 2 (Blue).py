...
def history():
    ...
    history_window.configure(background='#DFFEFF')
    ...
    history_title_label.config(font=("Comic Sans MS", 20, "underline"), background="#DFFEFF")
...
def setup_buttons():
    ...
    quit_button.config(height=1, width=17, font=("Comic Sans MS", 30), bg="#C2EBEC")

    submit_button = Button(main_window, text="Submit", command=submit)
    submit_button.place(x=40, y=700)
    submit_button.config(height=1, width=38, font=("Comic Sans MS", 30), bg="#C2EBEC")

    history_button = Button(main_window, text="History", command=history)
    history_button.place(x=40, y=850)
    history_button.config(height=1, width=17, font=("Comic Sans MS", 30), bg="#C2EBEC")
...
def setup_main_window():
    ...
    title_label.config(font=("Comic Sans MS", 45, "underline"), background="#DFFEFF")
...
main_window = Tk()    
main_window.configure(background='#DFFEFF')
