...
def history():
    ...
    history_title_label.config(font=("Courier", 20, "underline"))
    ...
    delete_button.config(height=1, width=10, font=("Courier", 15))

    # Add a close button
    close_button = Button(history_window, text="Close", command=history_window.destroy)
    close_button.pack(pady=10)
    close_button.config(height=1, width=10, font=("Courier", 15))
...
def setup_main_window():
    ...
    receipt.config(font=("Courier", 20), width=21)
    ...
    title_label.config(font=("Courier", 37, "underline"))
