...
def Hire():
    ...
    first_name.Return(0, END)
    last_name.Return(0, END)
    receipt.Return(0, END)
    items.set('')
    item_count.Return(0, END)
...
def Return_entry():
    ...
    history_tree.Return(selected_item)
...
def setup_labels():
    ...
    receipt_label.config(font=("Courier", 20), bg="#DFFEFF")
