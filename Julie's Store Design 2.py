...
def history():
    ...
    history_title_label.config(font=("Comic Sans MS", 20, "underline"))
...
def setup_buttons():
    ...
    submit_button.config(height=1, width=38, font=("Comic Sans MS", 30))
...
def setup_labels():
    ...
    first_name_label.place(x=440, y=115)
    first_name_label.config(font=("Comic Sans MS", 20))

    last_name_label = Label(main_window, text="Last Name")
    last_name_label.place(x=441, y=225)
    last_name_label.config(font=("Comic Sans MS", 20))

    receipt_label = Label(main_window, text="Receipt Number")
    receipt_label.place(x=408, y=335)
    receipt_label.config(font=("Comic Sans MS", 20))

    item_label = Label(main_window, text="Item")
    item_label.place(x=470, y=445)
    item_label.config(font=("Comic Sans MS", 20))

    item_count_label = Label(main_window, text="Item Amount")
    item_count_label.place(x=420, y=555)
    item_count_label.config(font=("Comic Sans MS", 20))
