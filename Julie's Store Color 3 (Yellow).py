...
def history():
    ...
    history_window.configure(background='#FFFFD1')
    ...
    history_title_label.config(font=("Comic Sans MS", 20, "underline"), background="#FFFFD1")
...
def setup_buttons():
    ...
    quit_button.config(height=1, width=17, font=("Comic Sans MS", 30), bg="#E2E2A2")

    submit_button = Button(main_window, text="Submit", command=submit)
    submit_button.place(x=40, y=700)
    submit_button.config(height=1, width=38, font=("Comic Sans MS", 30), bg="#E2E2A2")

    history_button = Button(main_window, text="History", command=history)
    history_button.place(x=40, y=850)
    history_button.config(height=1, width=17, font=("Comic Sans MS", 30), bg="#E2E2A2")
...
def setup_main_window():
    ...
    title_label.config(font=("Comic Sans MS", 45, "underline"), background="#FFFFD1")
...
main_window = Tk()    
main_window.configure(background='#FFFFD1')
